...
Используемые функции для анализа:
1. Функция для построения графиков
   <details>
...
2. Функция для теста Хи-квадрат с построением тепловой карты. Считаем уровень значимости равным 0.05, значит если p_value < 0.05, то мы отвергаем гипотезу $H_0$ и принимаем альтернативную - $H_1$
   <details>
...
3. Рассчет коэффициента V Крамера
   <details>
